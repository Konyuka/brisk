        ...
        <div class="grid gap-8 row-gap-5 mb-8 md:row-gap-8 lg:grid-cols-4 sm:grid-cols-2">
          ...
          >
            <div class="h-full p-5 border border-l-0 rounded-r shadow-sm">
              ...
              <p class="text-2xl text-green-900 font-extrabold">
                30
              </p>
            </div>
          </div>
                    ...
                    >
                      ...
                      <td class="pl-2">
                        <div class="flex items-center">
                          ...
                          <p class="text-xs sm:text-sm leading-none text-gray-600 sm:ml-1 ml-2">{{ product.product_quantity }} Grams</p>
                        </div>
                      </td>
                      <td class="pl-2">
                        <div class="flex items-center">
                          <i class="fas fa-boxes-packing text-green-900"></i>
                          <p class="text-xs sm:text-sm leading-none text-gray-600 sm:ml-1 ml-2">{{ product.stock_quantity }} items</p> 
                        </div>
                      </td>
                      <td class="pl-2">
                        <div class="flex items-center">
                          <i class="fas fa-money-bill-trend-up text-green-900"></i>
                          <p class="text-xs sm:text-sm leading-none text-gray-600 sm:ml-1 ml-2">{{ product.sales_price }} KES</p>
                        </div>
                      </td>
                      <td>
