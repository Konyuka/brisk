            ...
            <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
              <div class="text-center">
                ...
                >
                  ...
                  <span class="block text-indigo-600 xl:inline">POS</span>
                </h1>
                <p
                ...
                <div v-if="canLogin">
                  ...
                  >
                    ...
                    >
                      <Link
                        :href="route('register')"
                        class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 hover:text-white bg-white hover:bg-gray-900 md:py-4 md:text-lg md:px-10"
                      >
                        Register
                      </Link>
                    </div>
