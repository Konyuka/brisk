  ...
  <AppLayout>
    <div class="bg-gray-50">
      <main class="max-w-2xl mx-auto pt-8 pb-24 sm:pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        >
          <div
            class="flex sm:items-baseline sm:space-x-4 flex-col sm:flex-row justify-between"
          >
            <div>
              <div>
                <h1
                  class="text-2xl font-bold tracking-tight text-gray-900 sm:tracking-tight sm:text-3xl"
                >
                  Invoice #{{ sale.invoice_number }}
                </h1>
                <button
                  @click="actionTrigger()"
                  class="hidden text-md font-bold text-green-900 hover:text-green-900 sm:block"
                >
                  Print invoice<span aria-hidden="true">
                    &rarr; <i class="fas fa-print ml-1"></i
                  ></span>
                </button>
              </div>
            </div>
            <div>
              <div
                class="bg-light-green-100 border-t-4 border-green-500 rounded-b text-teal-900 px-4 py-3 shadow-md"
                role="alert"
              >
                <div class="flex">
                  <div class="py-1">
                    <i class="fa-2x fa-solid fa-face-smile-beam text-green-500 mr-4"></i>
                  </div>
                  <div>
                    <p class="font-bold">Hurray! Sale Closed</p>
                    <p class="text-sm">The sale has been processed succeefully</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <button
            @click="actionTrigger()"
            class="text-sm font-bold text-green-600 hover:text-green-500 sm:hidden"
          >
            Print invoice<span aria-hidden="true">
              &rarr; <i class="fas fa-print ml-1"></i
            ></span>
                ...
                <div class="mt-6 lg:mt-0 lg:col-span-5">
                  <dl class="grid grid-cols-2 gap-x-6 text-sm">
                    <div>
                      ...
                      <button
                        type="button"
                        class="mt-3 font-medium text-green-900 hover:text-gray-300"
                      >
                        <i class="fas fa-pencil mr-2"></i> Edit Details
                      </button>
                    </div>
                    <div>
                      ...
                      <dd class="mt-3 text-gray-500 space-y-3">
                        ...
                        <button
                          type="button"
                          class="font-medium text-green-900 hover:text-gray-300"
                        >
                          <i class="fas fa-pencil mr-2"></i> Edit Address
                        </button>
                      </dd>
                    </div>
                  </dl>
        ...
        <section aria-labelledby="summary-heading" class="mt-16">
          ...
          >
            <dl
              class="grid grid-cols-1 gap-6 text-sm sm:grid-cols-2 md:gap-x-8 lg:col-span-7"
            >
              <div>
                ...
                <dd class="-ml-4 -mt-1 flex flex-wrap">
                  <select
                    ...
                    class="font-bold ml-3 mt-4 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-green-900 focus:border-green-900 sm:text-sm"
                  >
                    <option class="italic font-semibold" value="cash">Direct Cash</option>
                    <option class="italic font-semibold" value="mpesa">
                      Mpesa Mobile
                    </option>
                    <option class="italic font-semibold" value="bank">
                      Bank Transter
                    </option>
                    <option class="italic font-semibold" value="bank">Over Draft</option>
                  </select>
          ...
          <div class="border-t border-gray-200 py-6 px-4 sm:px-6 lg:p-8">
            ...
            <p class="text-sm font-medium text-gray-900">
              Sale Timestamp at <span class="font-bold">{{ invoiceTime }}</span>
            </p>
            <div class="mt-6" aria-hidden="true">
              <div class="bg-light-green-400 rounded-full overflow-hidden">
                <div
                  class="h-2 bg-green-900 rounded-full"
                  style="width: calc((1 * 6 + 1) / 8 * 100%)"
                ></div>
              </div>
              <div
              ...
              >
                ...
                <div class="text-right mt-20">
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                      ...
                      >
                        <span class="text-gray-500 sm:text-sm">
                          <i class="fa-solid fa-money-bill-transfer text-green-900"></i>
                        </span>
                      </div>
                      <input
                        v-model="amountPaid"
                        ...
                        name="price"
                        id="price"
                        class="ml-2 text-gray-800 font-bold focus:ring-green-900 focus:border-green-900 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md"
                        :placeholder="'Expected ' + grandTotal"
                      ...
                      >
                        <span
                          class="font-bold text-gray-500 sm:text-sm"
                          id="price-currency"
                        >
                          KES
                        </span>
                  ...
                  <button
                    @click="finishSale"
                    class="font-extrabold text-green-900 text-2xl underline"
                  >
                    Finish Sale <i class="ml-2 fas fa-clipboard-check"></i>
                  </button>
                </div>
              </div>
              <div class="sm:hidden mt-14 flex flex-col sm:flex-row justify-center">
                <div class="mb-5">
                  <label for="price" class="block text-sm font-medium text-gray-700"
                    >Amount Paid</label
                  >
